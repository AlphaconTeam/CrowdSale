...
contract AlphaconCrowdsale is BaseCrowdsale, MintableBaseCrowdsale, BonusCrowdsale, BlockIntervalCrowdsale, KYCCrowdsale, StagedCrowdsale, FinishMintingCrowdsale {
  ...
  function AlphaconCrowdsale(bytes32[4] args) 
    BaseCrowdsale()
  ...
  function generateHoldersTokens(uint256 _targetTotalSupply) internal {
      ...
      generateTargetTokens(multisig0, _targetTotalSupply, 200);

      generateTargetTokens(multisig1, _targetTotalSupply, 200);

      generateTargetTokens(multisig2, _targetTotalSupply, 200);
  }
